...
import com.foxconn.sw.data.entity.SwMsgPoolExample.Criteria;
import com.foxconn.sw.data.entity.SwMsgPoolExample.Criterion;
...
public class SwMsgPoolSqlProvider {
    ...
    public String deleteByExample(SwMsgPoolExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("sw_msg_pool");
    ...
    public String selectByExample(SwMsgPoolExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SwMsgPool record = (SwMsgPool) parameter.get("record");
        SwMsgPoolExample example = (SwMsgPoolExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("sw_msg_pool");
    ...
    public String updateByPrimaryKeySelective(SwMsgPool record) {
        SQL sql = new SQL();
        sql.UPDATE("sw_msg_pool");
    ...
    protected void applyWhere(SQL sql, SwMsgPoolExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
