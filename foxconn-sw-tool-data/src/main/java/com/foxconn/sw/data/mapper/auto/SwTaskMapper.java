...
public interface SwTaskMapper {
    ...
    @Insert({
        "insert into sw_task (task_no, title, ",
        ...
        "dead_line, reflection, ",
        "create_time, datetime_lastchange, ",
        "description)",
        "values (#{taskNo,jdbcType=BIGINT}, #{title,jdbcType=VARCHAR}, ",
        "#{topCategory,jdbcType=VARCHAR}, #{category,jdbcType=VARCHAR}, ",
        "#{topProject,jdbcType=VARCHAR}, #{project,jdbcType=VARCHAR}, ",
        "#{taskType,jdbcType=VARCHAR}, #{level,jdbcType=VARCHAR}, ",
        ...
        "#{deadLine,jdbcType=VARCHAR}, #{reflection,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "id, task_no, title, top_category, category, top_project, project, task_type, ",
        "level, progress_percent, status, reject_status, proposer_eid, manager_eid, handle_eid, ",
        "dead_line, reflection, create_time, datetime_lastchange, description",
        "from sw_task",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
