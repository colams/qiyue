...
import com.foxconn.sw.data.entity.SwWorkReportScoreExample.Criteria;
import com.foxconn.sw.data.entity.SwWorkReportScoreExample.Criterion;
import com.foxconn.sw.data.entity.SwWorkReportScoreExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class SwWorkReportScoreSqlProvider {

    public String deleteByExample(SwWorkReportScoreExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("sw_work_report_score");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(SwWorkReportScore record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("sw_work_report_score");
    ...
    public String selectByExample(SwWorkReportScoreExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SwWorkReportScore record = (SwWorkReportScore) parameter.get("record");
        SwWorkReportScoreExample example = (SwWorkReportScoreExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("sw_work_report_score");
    ...
    public String updateByPrimaryKeySelective(SwWorkReportScore record) {
        SQL sql = new SQL();
        sql.UPDATE("sw_work_report_score");
    ...
    protected void applyWhere(SQL sql, SwWorkReportScoreExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
