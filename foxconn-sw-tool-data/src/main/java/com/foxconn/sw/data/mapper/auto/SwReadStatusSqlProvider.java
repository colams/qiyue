...
import com.foxconn.sw.data.entity.SwReadStatusExample.Criteria;
import com.foxconn.sw.data.entity.SwReadStatusExample.Criterion;
...
public class SwReadStatusSqlProvider {
    ...
    public String insertSelective(SwReadStatus record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("sw_read_status");
        
        if (record.getModuleType() != null) {
            sql.VALUES("module_type", "#{moduleType,jdbcType=VARCHAR}");
        }
        
        if (record.getForeignId() != null) {
            sql.VALUES("foreign_id", "#{foreignId,jdbcType=INTEGER}");
        }
    ...
    public String selectByExample(SwReadStatusExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SwReadStatus record = (SwReadStatus) parameter.get("record");
        SwReadStatusExample example = (SwReadStatusExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("sw_read_status");
        ...
        if (record.getForeignId() != null) {
            sql.SET("foreign_id = #{record.foreignId,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(SwReadStatus record) {
        SQL sql = new SQL();
        sql.UPDATE("sw_read_status");
        ...
        if (record.getForeignId() != null) {
            sql.SET("foreign_id = #{foreignId,jdbcType=INTEGER}");
        }
    ...
    protected void applyWhere(SQL sql, SwReadStatusExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
