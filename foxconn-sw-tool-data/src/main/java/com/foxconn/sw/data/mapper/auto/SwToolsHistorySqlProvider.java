...
import com.foxconn.sw.data.entity.SwToolsHistoryExample.Criteria;
import com.foxconn.sw.data.entity.SwToolsHistoryExample.Criterion;
import com.foxconn.sw.data.entity.SwToolsHistoryExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class SwToolsHistorySqlProvider {

    public String countByExample(SwToolsHistoryExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("sw_tools_history");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(SwToolsHistoryExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("sw_tools_history");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(SwToolsHistory record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("sw_tools_history");
        
        if (record.getToolId() != null) {
            sql.VALUES("tool_id", "#{toolId,jdbcType=INTEGER}");
        }
    ...
    public String selectByExample(SwToolsHistoryExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SwToolsHistory record = (SwToolsHistory) parameter.get("record");
        SwToolsHistoryExample example = (SwToolsHistoryExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("sw_tools_history");
        ...
        if (record.getToolId() != null) {
            sql.SET("tool_id = #{record.toolId,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(SwToolsHistory record) {
        SQL sql = new SQL();
        sql.UPDATE("sw_tools_history");
        
        if (record.getToolId() != null) {
            sql.SET("tool_id = #{toolId,jdbcType=INTEGER}");
        }
    ...
    protected void applyWhere(SQL sql, SwToolsHistoryExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
