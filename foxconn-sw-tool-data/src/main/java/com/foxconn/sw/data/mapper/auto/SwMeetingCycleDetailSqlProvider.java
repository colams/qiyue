...
import com.foxconn.sw.data.entity.SwMeetingCycleDetailExample.Criteria;
import com.foxconn.sw.data.entity.SwMeetingCycleDetailExample.Criterion;
import com.foxconn.sw.data.entity.SwMeetingCycleDetailExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class SwMeetingCycleDetailSqlProvider {

    public String countByExample(SwMeetingCycleDetailExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("sw_meeting_cycle_detail");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(SwMeetingCycleDetailExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("sw_meeting_cycle_detail");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(SwMeetingCycleDetail record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("sw_meeting_cycle_detail");
    ...
    public String selectByExample(SwMeetingCycleDetailExample example) {
        SQL sql = new SQL();
        ...
        sql.FROM("sw_meeting_cycle_detail");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SwMeetingCycleDetail record = (SwMeetingCycleDetail) parameter.get("record");
        SwMeetingCycleDetailExample example = (SwMeetingCycleDetailExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("sw_meeting_cycle_detail");
    ...
    public String updateByPrimaryKeySelective(SwMeetingCycleDetail record) {
        SQL sql = new SQL();
        sql.UPDATE("sw_meeting_cycle_detail");
    ...
    protected void applyWhere(SQL sql, SwMeetingCycleDetailExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
