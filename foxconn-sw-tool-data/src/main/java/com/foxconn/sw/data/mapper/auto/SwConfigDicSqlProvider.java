...
import com.foxconn.sw.data.entity.SwConfigDicExample.Criteria;
import com.foxconn.sw.data.entity.SwConfigDicExample.Criterion;
...
public class SwConfigDicSqlProvider {
    ...
    public String countByExample(SwConfigDicExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("sw_config_dic");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(SwConfigDicExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("sw_config_dic");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String selectByExample(SwConfigDicExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SwConfigDic record = (SwConfigDic) parameter.get("record");
        SwConfigDicExample example = (SwConfigDicExample) parameter.get("example");
    ...
    protected void applyWhere(SQL sql, SwConfigDicExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
