...
public interface SwDocumentMapper {
    ...
    @Insert({
        ...
        "category, department, ",
        "secret_level, author, ",
        "disable_down, resource_id, ",
        "source, creator, ",
        "file_type, content, ",
        "work_type, main_type, ",
        "sub_type, main_part, ",
        "supplier, expire_date, ",
        "project, phase, ",
        "config, issue_mode, ",
        "process, stage, ",
        ...
        "#{secretLevel,jdbcType=INTEGER}, #{author,jdbcType=VARCHAR}, ",
        "#{disableDown,jdbcType=INTEGER}, #{resourceId,jdbcType=INTEGER}, ",
        "#{source,jdbcType=VARCHAR}, #{creator,jdbcType=VARCHAR}, ",
        "#{fileType,jdbcType=INTEGER}, #{content,jdbcType=VARCHAR}, ",
        "#{workType,jdbcType=VARCHAR}, #{mainType,jdbcType=VARCHAR}, ",
        "#{subType,jdbcType=VARCHAR}, #{mainPart,jdbcType=VARCHAR}, ",
        "#{supplier,jdbcType=VARCHAR}, #{expireDate,jdbcType=VARCHAR}, ",
        "#{project,jdbcType=VARCHAR}, #{phase,jdbcType=VARCHAR}, ",
        "#{config,jdbcType=VARCHAR}, #{issueMode,jdbcType=VARCHAR}, ",
        "#{process,jdbcType=VARCHAR}, #{stage,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "id, document_name, file_version, category, department, secret_level, author, ",
        "disable_down, resource_id, source, creator, file_type, content, work_type, main_type, ",
        "sub_type, main_part, supplier, expire_date, project, phase, config, issue_mode, ",
        "process, stage, is_delete, create_time, datetime_lastchange",
        "from sw_document",
    ...
    @Update({
        ...
        "set document_name = #{documentName,jdbcType=VARCHAR},",
          ...
          "issue_mode = #{issueMode,jdbcType=VARCHAR},",
